            ...
            builder: (_, _a) {
              return Padding(
                padding: EdgeInsets.symmetric(
                    horizontal: _paddingTween.evaluate(_curvedAnim) as double),
                child: Row(
                  ...
                  children: [
                    Text(
                      ...
                      style: AppTextTheme.settingsMenuItemStyle
                          .apply(color: _colorTween.evaluate(_curvedAnim) as Color),
                    ),
                    Icon(
                      Icons.arrow_forward_ios,
                      color: _colorTween.evaluate(_curvedAnim) as Color,
                      size: 16,
                    ),
                  ],
                ),
